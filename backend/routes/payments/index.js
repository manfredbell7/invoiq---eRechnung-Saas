...
export async function paymentRoutes(fastify) {
  ...
  fastify.post('/payments/checkout', {
    ...
    try {
      ...
      return reply.code(500).send({ error: 'Checkout konnte nicht erstellt werden', details: err.message });
    }
  });
  ...
  fastify.post('/payments/portal', {
    ...
    try {
      ...
      return reply.code(500).send({ error: 'Portal konnte nicht geöffnet werden', details: err.message });
    }
  });
