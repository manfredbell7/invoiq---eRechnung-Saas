...
function AdminOverview({notify,isSuper}){
  ...
  return(<div className="fi">
    <div style={{display:"flex",justifyContent:"space-between",marginBottom:20}}>
      ...
      {isSuper&&<><button className="btn btn-ghost btn-sm" onClick={()=>notify("Export gestartet","success")}>↓ Export</button><button className="btn btn-ghost btn-sm" style={{marginLeft:8}} onClick={seedDemo} disabled={seedingDemo}>⚡ {seedingDemo?"Seeding...":"Seed Demo"}</button></></button></>}
    </div>
    <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10,marginBottom:16}}>
